...
export default function HowItWorks() {
  return (
    <section className="bg-[#FFFDF7] py-20 lg:py-24">
      <div className="max-w-7xl mx-auto px-4 text-center">
        {/* Heading */}
        <div className="max-w-2xl mx-auto mb-12 lg:mb-16">
          <h2 className="text-3xl lg:text-4xl font-bold text-[#1A2634] mb-4">
            How It Works
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="flex flex-col items-center">
            ...
            <h3 className="font-semibold text-[#1A2634] text-lg mb-2">Sign Up</h3>
            <p className="text-[#1A2634] text-sm leading-relaxed">
          ...
          <div className="flex flex-col items-center">
            ...
            <h3 className="font-semibold text-[#1A2634] text-lg mb-2">Choose Language</h3>
            <p className="text-[#1A2634] text-sm leading-relaxed">
          ...
          <div className="flex flex-col items-center">
            ...
            <h3 className="font-semibold text-[#1A2634] text-lg mb-2">Learn with Lessons</h3>
            <p className="text-[#1A2634] text-sm leading-relaxed">
          ...
          <div className="flex flex-col items-center">
            ...
            <h3 className="font-semibold text-[#1A2634] text-lg mb-2">Practice & Earn</h3>
