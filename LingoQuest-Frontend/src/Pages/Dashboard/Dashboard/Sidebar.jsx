...
export default function Sidebar() {
    ...
    <aside className="hidden lg:flex lg:w-64 bg-white border-r border-gray-200 p-6 flex-col justify-between">
      <div>
        ...
        <nav className="flex flex-col gap-4">
          <Link to='/dashboard'
            className="flex items-center gap-2 py-3 px-4 rounded-xl text-left font-semibold transition-colors text-gray-700 hover:bg-gray-100"
          >
            <img src={home} />
            <span>Dashboard</span>
          </Link>
  ...
  className="flex items-center gap-2 py-3 px-4 rounded-xl text-left font-semibold transition-colors text-gray-700 hover:bg-gray-100"
>
  <span className="text-lg">🤖</span> {/* Emoji icon */}
  <span>LingoAI</span>
</Link>
          <Link to='/profile'
            className="flex items-center gap-2 py-3 px-4 rounded-xl text-left font-semibold transition-colors text-gray-700 hover:bg-gray-100"
